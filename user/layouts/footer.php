         ...
         <div class="container">
            <div class="row">
               ...
               <div class="col-lg-4 col-md-6 order-lg-1 order-md-3 mb-sm-5">
                  ...
                  <h4 class="mb-0 mt-0"><a class="logo" href="https://www.grocistore.com/"><img style="max-width: 250px;"  src="https://www.grocistore.com/admin/uploads/logo1575713051.png" alt="Grocistore" ></a></h4>
                  <h1 style="font-size: 18px;">Online Grocery Store</h1>
               ...
               <div class="col-lg-2 col-md-6 order-lg-4 order-md-4">
                  ...
                  <div class="app">
                     <a href="https://bit.ly/grocistore" target="_blank"> <img src="https://www.grocistore.com/assets/img/google.png" alt=""></a>
                     <!-- <a href="#"><img src="https://www.grocistore.com/assets/img/apple.png" alt=""></a> -->
                  </div>
                  <br>
                  <div class="footer-social"><span><strong>Follow : </strong></span>
                     <a href="https://www.facebook.com/Groci-Store-101082614730695" target="_blank"><i class="mdi mdi-facebook"></i></a>
                     <a href="https://www.instagram.com/grocistore/" target="_blank"><i class="mdi mdi-instagram"></i></a>
                     <a href="https://twitter.com/grocistore" target="_blank"><i class="mdi mdi-twitter"></i></a>
