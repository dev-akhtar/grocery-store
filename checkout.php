        ...
        <div class="col-md-10 offset-md-1">
            <div class="card">
                    ...
                    <script>
                        ...
                        for(var i=0, len=localStorage.length; i<len; i++) {
                            ...
                            if(key.match(regexp)){
                                ...
                                document.write("<tr><td><img src='./supplier/images/"+ item.image +"' width='60px' alt=''></td> <td>" +item.title+"</td> <td style='max-width: 100px;'>&#8377;"+item.price+"</td><td style='max-width: 60px;'>"+item.orderQuantity+"</td><td>&#8377;"+(item.orderQuantity*item.price)+"</td></tr>");
                            }
                        }
                        if(flag == 0){
                ...
                <div class="card-footer">
                    <a class="btn btn-success" href="place-order.php">Proceed To Pay</a>
                    <span class="h5 px-3">Total amount: <span class="price text-success">&#8377;<span id="totalPayablePrice"><script>document.write(totalPrice)</script></span></span></span>
                </div>
            </div>
        </div>
    </div>
